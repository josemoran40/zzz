...
public class Parser extends java_cup.runtime.lr_parser {
 ...
 public final Class getSymbolContainer() {
  ...
  protected static final short[][] _action_table = 
    unpackFromStrings(new String[] {
    "\000\031\000\014\003\013\004\007\012\010\013\005\014" +
    "\006\001\002\000\016\002\ufffe\003\ufffe\004\ufffe\012\ufffe" +
    "\013\ufffe\014\ufffe\001\002\000\016\005\ufff4\006\ufff4\007" +
    "\ufff4\010\ufff4\011\ufff4\015\ufff4\001\002\000\012\004\007" +
    "\012\010\013\005\014\006\001\002\000\012\004\007\012" +
    "\010\013\005\014\006\001\002\000\016\005\ufff5\006\ufff5" +
    "\007\ufff5\010\ufff5\011\ufff5\015\ufff5\001\002\000\016\002" +
    "\000\003\013\004\007\012\010\013\005\014\006\001\002" +
    "\000\014\006\020\007\021\010\023\011\022\015\017\001" +
    "\002\000\004\015\016\001\002\000\004\002\015\001\002" +
    "\000\004\002\001\001\002\000\016\002\ufffc\003\ufffc\004" +
    "\ufffc\012\ufffc\013\ufffc\014\ufffc\001\002\000\016\002\ufffd" +
    "\003\ufffd\004\ufffd\012\ufffd\013\ufffd\014\ufffd\001\002\000" +
    "\012\004\007\012\010\013\005\014\006\001\002\000\012" +
    "\004\007\012\010\013\005\014\006\001\002\000\012\004" +
    "\007\012\010\013\005\014\006\001\002\000\012\004\007" +
    "\012\010\013\005\014\006\001\002\000\016\005\ufff8\006" +
    "\ufff8\007\ufff8\010\ufff8\011\ufff8\015\ufff8\001\002\000\016" +
    "\005\ufff7\006\ufff7\007\ufff7\010\ufff7\011\ufff7\015\ufff7\001" +
    "\002\000\016\005\ufff9\006\ufff9\007\ufff9\010\023\011\022" +
    "\015\ufff9\001\002\000\016\005\ufffa\006\ufffa\007\ufffa\010" +
    "\023\011\022\015\ufffa\001\002\000\016\002\uffff\003\uffff" +
    "\004\uffff\012\uffff\013\uffff\014\uffff\001\002\000\014\005" +
    "\032\006\020\007\021\010\023\011\022\001\002\000\016" +
    "\005\ufff6\006\ufff6\007\ufff6\010\ufff6\011\ufff6\015\ufff6\001" +
  ...
  protected static final short[][] _reduce_table = 
    unpackFromStrings(new String[] {
    "\000\031\000\012\002\013\003\003\004\011\005\010\001" +
    "\001\000\002\001\001\000\002\001\001\000\004\004\032" +
    "\001\001\000\004\004\030\001\001\000\002\001\001\000" +
    "\006\003\027\004\011\001\001\000\002\001\001\000\002" +
  ...
  public final java_cup.runtime.Symbol CUP$Parser$do_action_part00000000(
	...
	a.forEach((t)->{
		...
		Object a = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT=list; RESULT.add(new String(a.toString())); 
		...
		int aright = ((java_cup.runtime.Symbol)CUP$Parser$stack.peek()).right;
		Object a = (Object)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT= new ArrayList<String>(); RESULT.add(new String(a.toString())); 
		...
		Double exp = (Double)((java_cup.runtime.Symbol) CUP$Parser$stack.elementAt(CUP$Parser$top-1)).value;
		 RESULT=exp;
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 6: // expression ::= UMINUS expression 
            {
              Double RESULT =null;
		...
		Double right = (Double)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT=left-right; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 9: // expression ::= expression TIMES expression 
            {
              Double RESULT =null;
		int leftleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).left;
		int leftright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-2)).right;
		...
		Double right = (Double)((java_cup.runtime.Symbol) CUP$Parser$stack.peek()).value;
		 RESULT=left/right; 
          ...
          /*. . . . . . . . . . . . . . . . . . . .*/
          case 11: // expression ::= PARLEFT expression PARRIGHT 
            {
              Double RESULT =null;
		int expleft = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).left;
		int expright = ((java_cup.runtime.Symbol)CUP$Parser$stack.elementAt(CUP$Parser$top-1)).right;
